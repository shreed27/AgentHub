...
import { Wallet, TrendingUp, TrendingDown, RefreshCcw, DollarSign, PieChart as PieChartIcon, Loader2, ChevronDown, BarChart3 } from "lucide-react";
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                // Generate performance data from current total
